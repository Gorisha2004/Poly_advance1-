...
const ABI = require("../artifacts/contracts/music.sol/music.json");
...
async function main() {
  ...
  const NFT = await ethers.getContractFactory("music");
  const nft = await NFT.attach("0x41c0332B5950875cf7601874A1DEb3a205B9Bed6");
